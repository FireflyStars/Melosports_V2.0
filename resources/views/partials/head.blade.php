...
<meta content="width=device-width, initial-scale=1.0"
	  ...
	  <meta name="keywords" content="{{$application->meta_keyword}}">
...
<!-- <link rel="stylesheet" href="{{ url('public/adminlte/css/font-awesome/font-awesome.min.css') }}"> -->
...
<link href="{{ url('public/adminlte/plugins/timepicker/bootstrap-timepicker.min.css') }}" rel="stylesheet">
<link rel="stylesheet"
