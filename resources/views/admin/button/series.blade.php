@can('series_view')
                                    <a href="{{ route('admin.series.show',[$users->id]) }}" class="btn btn-large btn-primary">@lang('quickadmin.qa_view')</a>
                                   @endcan
								   @can('series_view')
                                    <a href="{{ route('admin.series.edit',[$users->id]) }}" class="btn btn-large btn-info">@lang('quickadmin.qa_edit')</a>
