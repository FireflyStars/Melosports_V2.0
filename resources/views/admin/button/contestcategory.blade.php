@can('series_view')
                                    <a href="{{ route('admin.contestcategory.show',[$users->id]) }}" class="btn btn-large btn-primary">@lang('quickadmin.qa_view')</a>
                                   @endcan
								   @can('series_view')
                                    <a href="{{ route('admin.contestcategory.edit',[$users->id]) }}" class="btn btn-large btn-info">@lang('quickadmin.qa_edit')</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Do you want to Delete {{ $users->contest_category }}?</p>
                <p class="text-warning"><small>If you don't save, your changes will be lost.</small></p>
            </div>
			<form  method="post" action="{{url('admin/contestcategory-delete')}}">
...
<div id="myModalActive{{ $users->id }}" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Do you want to @if($users->is_active ==1) Deactive @else active @endif {{ $users->contest_category }}?</p>
                <p class="text-warning"><small></small></p>
            </div>
			<form  method="post" action="{{url('admin/contestcategory-active')}}">
