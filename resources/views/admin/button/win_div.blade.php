@can('contest_view')
                                    ...
                                    <a href="{{ route('admin.winner_divide.show',[$users->id]) }}" class="btn btn-large btn-primary">@lang('quickadmin.qa_view')</a>

                                   @endcan

								   @can('contest_view')

                                    <a href="{{ route('admin.winner_divide.edit',[$users->id]) }}" class="btn btn-large btn-info">@lang('quickadmin.qa_edit')</a>
...
<div id="myModal{{ $users->id }}" class="modal fade">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
			...
			<form  method="post" action="{{url('admin/winner_divide-delete')}}">
...
<div id="myModalActive{{ $users->id }}" class="modal fade">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
			...
			<form  method="post" action="{{url('admin/winner_divide-active')}}">
