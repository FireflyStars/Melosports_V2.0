...
<!-- breadcrumb section -->
   ...
   <div class="row">
     <ul class="breadcrumb">
       ...
       <li class="active"> Contest Category</li>
     </ul>
   </div> 
   ...
   <div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 lr-add_new clearfix">
      @can('series_create')
      <p class="lr-add">
        <a href="{{ route('admin.contestcategory.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>  
      </p>
      @endcan
    </div>
   </div>
...
$(document).ready(function() {
    oTable = $('#users').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('admin.datatable.contestcategory') }}",
        "columns": [
		
            {data: 'contest_category', name: 'contest_category'},
