...
<meta name="csrf-token" content="{{ csrf_token() }}" />
	...
	<div class="container" >
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-head text-center">Points Table</h1>
			</div>
		</div>	
		...
		<div class="row" >
			...
			<div class="about-box-content">
				...
				<h4>Economy Rate(3 overs and above)</h4>
				<div class="tb-cont">
					<table>  
						<tr style="background-color:#d7d7d7;text-align:center;">
							<td>Type of Points</td>
