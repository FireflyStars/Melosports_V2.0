        		...
        		<div class="cs-pitch-content">
        				...
        				<div class="cs-pitch-col">
        				  <!-- Player  -->
        					<div class="cs-pitch-payer">
        						...
        						<img src="{{url('public/site/image/dhoni.png')}}" width="40">
        						<div class="cs-pitch-payer-name" style="background: #ff9800">MS Dhoni</div>
        						<div class="cs-pitch-payer-points">10 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        			</div>
        			...
        			<div class="cs-pitch-row">
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						...
        						<div class="cs-pitch-payer-name" style="background: #ff5722">Virat</div>
        						<div class="cs-pitch-payer-points">10 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Rohit</div>
        						<div class="cs-pitch-payer-points">9 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Rahane</div>
        						<div class="cs-pitch-payer-points">8 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Dawan</div>
        						<div class="cs-pitch-payer-points">8.5 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        			</div>
        			...
        			<div class="cs-pitch-row">
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name" style="background: #ff9800">Raina</div>
        						<div class="cs-pitch-payer-points">9 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Aswin</div>
        						<div class="cs-pitch-payer-points">8 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Jadeja</div>
        						<div class="cs-pitch-payer-points">7 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        			</div>
        			...
        			<div class="cs-pitch-row">
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Buvi</div>
        						<div class="cs-pitch-payer-points">10 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Shami</div>
        						<div class="cs-pitch-payer-points">8 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
        				<div class="cs-pitch-col">
        					...
        					<div class="cs-pitch-payer">
        						<img src="{{url('public/site/image/default-player.png')}}" width="40">
        						<div class="cs-pitch-payer-name">Bumhra</div>
        						<div class="cs-pitch-payer-points">8.5 PTS</div>
        					</div>
        				 	<!-- Player End  -->
        				</div>
