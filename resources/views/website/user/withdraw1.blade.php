 ...
 Withdraw Play Points</a> </p>  </p>
		...
		<div class="col-sm-4">
			<div class="state-box">
				...
				<p class="font-bold">@if(Auth::user()->user_wallet_current_amount) RS. {{round(Auth::user()->user_wallet_current_amount,2)}} @else 0 @endif</p>
		...
		<div class="wall_tab">
			<div class="tabbable" style="margin-bottom: 9px;">
				...
				<ul class="nav nav-tabs">								
					...
					<li><a href="#2a" data-toggle="tab">Withdraw Status</a></li>					<li><a href="#3a" data-toggle="tab">Point Withdraw Status</a></li>
						  ...
						  <div class="tab-pane" id="5a">
							<div class="wall_tableft">
								...
								<div class="table_wa">
									...
									{
										//$match=App\Match::whereunique_id($fc->match_id)->first();
