...
//console.log(credit);
function count_batsman_hide(pid,matchid,teamno)
{
...
function count_bowler_hide(pid,matchid,teamno)
{
	/* var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url:"{{url('delete-selected-player')}}",
...
function count_allrounder_hide(pid,matchid,teamno)
{
/* var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url:"{{url('delete-selected-player')}}",
...
function count_wicketkeeper_hide(pid,matchid,teamno)
{
	/* var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url:"{{url('delete-selected-player')}}",
    		...
    		<div class="container">
				...
				<div class="row">
					...
					<div class="footer_line">
						...
						<span class="line_img"><img src="{{ url('public/site/image/foot.png') }}"></span>
            	...
            	<div class="row">
                	<div class="col-md-3 footer_con">
						 ...
						 <ul>
							...
							<li>
                            	<a href="{{URL::to('how-to-play')}}">How to Play Cricket</a>
                    ...
                    <div class="col-md-3 footer_con">
                        <ul>
                            ...
                            <li>
                            <a href="{{URL::to('u-point')}}">Point System</a>
                            </li>
							 <li>
                          <a href="{{URL::to('/main')}}">Cricket Contest</a>
                            </li>
							 <li>
                            <a href="{{url('score-post')}}">Live Scores</a>
                            </li>
                    ...
                    <div class="col-md-3 footer_con">
                        ...
                        <ul>
                            ...
                            <li>
                            <a href="{{url('u_testimonial')}}">Testimonial</a>
                            </li>
							 <li>
                            <a href="{{url::to('u_news')}}">News</a>
                            </li>
					...
					<div class="col-md-3 footer_con">
                        ...
                        <ul>
                            ...
                            <li>
                            <a target="_blank" href=@if($site->social_links['fb']) "{{$site->social_links['fb']}}" @endif class="btn btn-share-sm bg-facebook" ><img src="{{ url('public/site/image/fb.png') }}"></a>
                            <a href= @if($site->social_links['twi'])"{{$site->social_links['twi']}}" @endif class="btn btn-share-sm bg-twitter" ><img src="{{ url('public/site/image/tw.png') }}"></a>
                            <a  href=@if($site->social_links['you'])"{{$site->social_links['you']}}" @endif class="btn btn-share-sm bg-google"><img src="{{ url('public/site/image/g+.png') }}"></a>
				...
				<div class="row">
					...
					<div class="footer_page">
						...
						<p> <a href="#"> Privacy Policy </a> | <a href="#"> 	Terms & Conditions </a> | <a href="{{URL::to('terms-and-conditions')}}"> 	disclaimer </a> | <a href="#"> Sitemap </a> </p>
						
						<p> Copyright 	&#169; {{$site->site_name}} . All Rights Reserved. </p>
