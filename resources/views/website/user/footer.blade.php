            ...
            <div class="container">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <ul class="cs-footer-links">
                            ...
                            <li><a href="{{URL::to('faq')}}">FAQs</a></li>
                              <li><a href="{{URL::to('document')}}">Document</a></li>
                        </ul>
                    </div>
                ...
                <div class="copyright-bar clearfix">
                  ...
                  <div class="row mt-4">
                        ...
                        <div class="col-lg-6">
                         <ul class="text-right-md ">  <a target="_blank"  class="text-white mr-2" href="{{URL::to('privacy-policy')}}"> Privacy Policy </a> | 
...
function select_tick(e,type)
{
 ...
 else if(pteamname==team_name2)
 {
  ...
  /*  if((type=="batsman") && c_team_name1==7 && ($(e).hasClass("active")) )
 {
 count_batsman_hide(pid,matchid,teamno,pteamname);
 }	
 if((type=="bowler") && c_team_name1==7 && ($(e).hasClass("active")) )
 {
 count_bowler_hide(pid,matchid,teamno,pteamname);
 }
 if((type=="allrounder") && c_team_name1==7 && ($(e).hasClass("active")) )
 {
 count_allrounder_hide(pid,matchid,teamno,pteamname);
 }
 if((type=="wicketkeeper") && c_team_name1==7 && ($(e).hasClass("active")) )
 {
...
/* else {
	//c_team_name2--;
				$('.error_test').show();
			$('.error_test').text('Maximum 7 Player Select Same Team');
			setTimeout(function(){ $('.error_test').hide(); }, 2000);
			}
} */
/* else {
...
{
	$('#click_captain    #player_batting_c'+pid).remove();
	$('#click_vicecaptain    #player_batting_vc'+pid).remove();
...
if(pcount!=11)
{
	...
	$('#change_buttton').prop('disabled', true); */
	 $('.captain #captain').prop('disabled', true);
	$('.vc_captain #vicecaptain').prop('disabled', true);
...
else
{
	...
	$("#change_buttton").addClass("button_disabled");
	$('#change_buttton').prop('disabled', true); */
	 $('.captain #captain').prop('disabled', false);
	$('.vc_captain #vicecaptain').prop('disabled', false);
...
if(pcount==11)
{
	...
	var a = $('#popup_11player').html();
var b = $('.modal-body_team_create').html(a);
	
	
	$('#myModal_team_create').modal('show');
