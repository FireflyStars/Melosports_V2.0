...
<div id='loadingmessage' style='display:none'>
 ...
 <!-- <img src="{{ URL::to('public/site/image/lg.comet-spinner.gif') }}"/>-->
  ...
  color: #d9480f;
									 ...
									 @if (date('Y-m-dH:i:s')
                        > $con)
					<?php $cricketMatchesTxt=file_get_contents('http://cricapi.com/api/fantasySummary/?apikey='.$apikey.'&&unique_id='.$unique_id);
    ...
    <div class="white-box p-0">
        @if($contest_first_team)
            ...
            <div class="gray-bg clearfix" >
                ...
                <div class="btn-group" style="width: 30%; margin-top: 4px; margin-left: 9px; ">
...
@endif	
 ...
 ?>
  ...
  <?php	  $playingrole = file_get_contents('http://cricapi.com/api/playerStats/?apikey='.$apikey.'&&pid='.$team_players->captain);	
  ...
  <?php	  $playingrole = file_get_contents('http://cricapi.com/api/playerStats/?apikey='.$apikey.'&&pid='.$team_players->vice_captain);	
										$db = json_decode($playingrole,true);
										$url = $db['imageURL'];?>
                              <img src="{{ $url }}">
            ...
            <?php $json_play=json_decode($team_players->team_players); ?>
                ...
                <div class="batsman">
					...
					<?php	  $playingrole = file_get_contents('http://cricapi.com/api/playerStats/?apikey='.$apikey.'&&pid='.$all->player_id);	
										$db = json_decode($playingrole,true);
										$url = $db['imageURL'];?>
                              <img src="{{ $url }}">
						@else
                        ...
                        <div>
                            ...
                            <input style="width:100%; border: none;text-align: center;font-size: 9px;" type="text" readonly  value="{{$all->player_name}}">
							</a>
@if (date('Y-m-dH:i:s') > $con)                     
					 @php($point_sum_test=DB::table('fantasy_pointupdate_test')->whereplayer_id($all->player_id)->wherematch_id($unique_id)->get())
					  <?php 
				...
				$indiual_player_sum+=$bat_pt+$bowl_pt+$field_pt;
					...
					?>
				  <input style="width:100%; border: none;text-align: center;font-size: 9px;" type="text" readonly  value="{{$indiual_player_sum}}">	  
@endif					 
                ...
                <div class="batsman">
                    <div class="palyer_icon">
						...
						$playingrole = file_get_contents('http://cricapi.com/api/playerStats/?apikey='.$apikey.'&&pid='.$all->player_id);	
										$db = json_decode($playingrole,true);
										$url = $db['imageURL'];?>
										 <img src="{{ $url }}">
                            <!--  <img src="{{ url('public/site/image/in_bat_sub.png') }}">-->
 ...
 ?>
                    ...
                    <div class="batsman">
                        ...
                        <div class="palyer_icon">
							...
							<a href="#" class="hover_test" id="<?php echo $c_name_list->player_id .'-'. $team_players->id; ?>">
<?php
$playingrole = file_get_contents('http://cricapi.com/api/playerStats/?apikey='.$apikey.'&&pid='.$c_name_list->player_id);	
										$db = json_decode($playingrole,true);
										$url = $db['imageURL'];?>
										 <img src="{{ $url }}">
                             <!--   <img src="{{ url('public/site/image/in_bat_sub.png') }}">-->
                ...
                <?php $fetch = DB::table('matches')
							...
							$time_sar = strtotime($subd.$subt);
                               ...
                               $tim = date("H:i:s", strtotime('+300 minutes', $time));
									...
									?>
                    @if (date('Y-m-dH:i:s')
                    < $con) <a href="{{url('create-team/'.base64_encode(Session::get('unique_id')).'/'.base64_encode('1'))}}"><img src="{{url('public/site/image/create_team.png')}}">&nbsp;&nbsp;Create Your Team</a>
                        @else
 ...
 -->
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{URL::to('payment-view')}}" method="post">
                                    ...
                                    <ul class="amtOptions">
                                        ...
                                        <a class="button" data-saravana="115">Rs.115</a>
                                        <a class="button" data-saravana="250">Rs.250</a>
                                        <a class="button" data-saravana="600">Rs.600</a>
		...
		@if (date('Y-m-dH:i:s') < $con) 
			...
			?>
                    ...
                    @else There Is No Contest You Join!!!!!!!! @endif
